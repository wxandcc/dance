        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <div class="ckbox ckbox-default">
                    <input name="Auth[<?= $key ?>][all]" type="checkbox" value="1" id="<?=$key."-all"?>" <?= $config && $config[$key]['all'] == 1 ? 'checked="checked"': "" ?>>
                ...
                <div class="col-sm-8">
                    ...
                    foreach ($auth['action'] as $action => $name) {
                        ...
                        <div class="ckbox ckbox-success">
                            <input name="Auth[<?= $key ?>][action][<?=$action?>]" type="checkbox" id="<?=$key."-action-".$action?>" value="1" <?= $config &&  $config[$key]['action'][$action] == 1 ? 'checked="checked"': "" ?>>
